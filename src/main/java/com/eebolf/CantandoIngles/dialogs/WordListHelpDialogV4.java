...
public class WordListHelpDialogV4 extends SimpleDialogV4 {

	public static WordListHelpDialogV4 newInstance (Bundle startingBundle) {
		WordListHelpDialogV4 cD = new WordListHelpDialogV4();
  ...
  private Button languageButton;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  ...
	  if (null != savedInstanceState && savedInstanceState.containsKey(inEnglishBoolean)) {
		...
		View v = inflater.inflate(R.layout.dialog_word_list_help, container, false);
    ...
    spanishText = v.findViewById(R.id.spanish_explanation);
		...
		okButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				WordListHelpDialogV4.this.dismiss();
			}
		});
