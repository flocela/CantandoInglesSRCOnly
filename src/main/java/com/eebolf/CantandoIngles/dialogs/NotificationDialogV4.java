...
public class NotificationDialogV4 extends SimpleDialogV4 {
   ...
   */
	public static NotificationDialogV4 newInstance (Bundle startingBundle) {
		NotificationDialogV4 cD = new NotificationDialogV4();
		cD.setArguments(startingBundle);
		return cD;
	}
	
	public static NotificationDialogV4 newInstance (String title, String message) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		okButton.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				NotificationDialogV4.this.dismiss();
			}
		});
